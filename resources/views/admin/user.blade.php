                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            @endif
                                <div class="card-body">
                                    <div class="d-md-flex">
                                        <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les utilisateurs</h4>
                                        ...
                                        <table class="table stylish-table no-wrap">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th class="border-top-0">Rôles</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="align-middle">{{implode(',', $users->roles()->get()->pluck('nom')->toArray())}}</td>
                                                    <td class="align-middle"><a href="{{route('user.edit', $users->id)}}" type="button" class="btn btn-outline-success"> <i class="fas fa-edit"></i> edit</a></td>
