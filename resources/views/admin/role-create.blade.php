                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-md-flex text-center">
                                        <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Ajouter un rôle</h4>
                                    ...
                                    <div class="table-responsive mt-5">
                                        <form action="{{route('role.store')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control mb-3" name="nom" id="nom" placeholder="nom"  >
                                            @if($errors->has('nom'))
